...
END {
	...
	prod1="a"
        ...
        for (i in product) {
                ...
                else if (product[i] > maxprodb) {
                        maxprodc = maxprodb
                        maxprodb = product[i]
                        prod3 = prod2
                        prod2 = i
                }
                else if (product[i] > maxprodc) {
                        maxprodc = product[i]
                        prod3 = i
                }
        }
	...
	print "2.C"
        print "1.", prod1, "dengan total", maxproda
        print "2.", prod2, "dengan total", maxprodb
        print "3.", prod3, "dengan total", maxprodc
...
#	print "2.C"
#	print "Personal Accessories:", proda, "dengan total", maxproda
#	print "Camping Equipment:", prodb, "dengan total", maxprodb
#	print "Outdoor Protection:", prodc, "dengan total", maxprodc
}
' /home/thalutn5/Documents/Soalshift1/nmr2/WA_Sales_Products_2012-14.csv 
#awk '
#{
#	split($0, arr, ",")
#	if (arr[7] == 2012) {
